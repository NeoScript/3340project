...
.data
file_loc: .asciiz "C:/Users/sgb150130/Downloads/3340project-master/3340project-master/Testing-Sriram/test.asm" #note: when launching from commandline, test.asm should be within the same folder as Mars.jar else it will default to base of the c:/ drive
buffer: .space 1
new_line: .asciiz "\n"
space_char: .asciiz " "
